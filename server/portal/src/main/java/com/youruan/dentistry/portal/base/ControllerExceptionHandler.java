...
import com.youruan.dentistry.portal.base.utils.WebUtils;
...
public class ControllerExceptionHandler {
    ...
    public Object handleAuthorizationException(UnauthenticatedException e, HttpServletRequest request) {
    ...
    @ExceptionHandler({IllegalArgumentException.class, SmsVerificationSendBusyException.class})
    ...
    public Object handleBindException(Exception e, HttpServletRequest request) {
        LOG.error("发生错误", e);
        if (WebUtils.isAjaxRequest(request)) {
