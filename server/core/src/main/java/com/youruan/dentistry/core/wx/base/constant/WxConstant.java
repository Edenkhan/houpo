...
public interface WxConstant {
     ...
     * 获取微信用户授权url
     */
    String BASIC_OAUTH_URL = "https://open.weixin.qq.com/connect/oauth2/authorize?appid="+APP_ID+"&redirect_uri=%s&response_type=code&scope=snsapi_login&state=GHOST#wechat_redirect";
    /**
     * 微信用户授权地址
     */
    String OAUTH_URI = "/api/oauth/start";
    /**
     * 用户授权，微信重定向地址
     */
